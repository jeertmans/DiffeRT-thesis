...
\begin{tikzpicture}[
  ...
  % ---------------------------------------------------------
  % Iteration 4: C = 0.00 (Converged)
  % ---------------------------------------------------------
  \drawbackground

  % Previous Specular Points
  \node[previous-intersection-point=0.25] (PPPS1) at (1.5, 1.5) {};
  \node[previous-intersection-point=0.25] (PPPS2) at (5, 2.0) {};;
  \node[previous-intersection-point=0.5] (PPS1) at (2.0, 2.0) {};
  \node[previous-intersection-point=0.5] (PPS2) at (5, 2.5) {};
  \node[previous-intersection-point=0.75] (PS1) at (2.4, 2.4) {};
  \node[previous-intersection-point=0.75] (PS2) at (5, 3.0) {};

  % True Specular Points (Calculated using the image method logic)
  \coordinate (S1) at (20/7, 20/7); % ~2.86, 2.86
  \coordinate (S2) at (5, 10/3);    % ~5.00, 3.33

  % Ray (Converged, valid)
  \draw[ray] (BS) -- (S1) -- (S2) -- (UE);
  ...
  % Cost Label
  \node[anchor=west] at (5.5, 2.5) {$C = 0.00$};
\end{tikzpicture}

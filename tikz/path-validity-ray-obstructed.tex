...
\begin{tikzpicture}[
    ...
    pathline/.style={draw=green!80!black, dashed, thick, opacity=0.75},
  ...
  % Second wall
  \draw[ground,pattern={Lines[angle=0]},,rotate around={-45:(-2,-1.5)}] (-2, -1.5) rectangle ++({1/cos(45)},-.1);
  \draw[wall] (-2, -1.5) -- (-1, -2.5);

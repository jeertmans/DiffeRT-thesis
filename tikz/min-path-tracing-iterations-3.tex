...
\begin{tikzpicture}[
  ...
  \node[previous-intersection-point=0.5] (PPS1) at (1.5, 1.5) {};
  \node[previous-intersection-point=0.5] (PPS2) at (5, 2.0) {};
  \node[previous-intersection-point=0.75] (PS1) at (2.0, 2.0) {};
  \node[previous-intersection-point=0.75] (PS2) at (5, 2.5) {};

  % Approximate Specular Points
  \coordinate (S1) at (2.4, 2.4);
  \coordinate (S2) at (5, 3.0);
  ...
  % Cost Label
  \node[anchor=west] at (5.5, 2.5) {$C = 0.21$};
\end{tikzpicture}
